...
/* export const student1 = nestedStudents[0];
export const student2 = nestedStudents[1][0];
export const student3 = nestedStudents[1][1];
export const student4 = nestedStudents[2][0];
export const student5 = nestedStudents[2][1]; */
// EXERCISE 6
