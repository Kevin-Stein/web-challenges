...
function addColor (redButton, greenButton, blueButton, grayButton){
  redButton (box.addColors = ("crimson"));
/*greenButton.style.color = 'royalblue';
  blueButton.style.backgroundColor = 'seagreen';
  grayButton.style.backgroundColor = 'darkslategray';  */
